...
public class Iterators {
    public static void main(String[] args) {
       ...
       /* while(myItr.hasNext()) {  //en basa konumlanan pointerdan sonra eleman var mi diye bakar
            ...
            myItr.remove(); //next'in verdigi elamani siler
        }
        System.out.println(myList); */
        ...
        while (myItr.hasNext()) {
            String tutucu = myItr.next();
            if(tutucu.equals("Tom")){
                myItr.remove();
                break;
            }
        }
        ...
        //System.out.println(yourListItr); referans verdi
       ...
       /* while (yourListItr.hasNext()){
        ...
        //ODEV: Sadece Can'a yildiz ekleyin

        while(yourListItr.hasNext()){
            String tutucu = yourListItr.next();
            if(tutucu.equals("Can")){
                yourListItr.set(tutucu+"*");
            }
        }
        System.out.println(yourList);
