...
public class IfStatements01 {
    public static void main(String[] args) {
        ...
        /*Ornek 1: Kullanicidan yas degerini alan ve yasin hangi evrede oldugunu
        ...
        /*Example 1: Create the code that takes the age value from the user and prints
        the stage of age according to the following table.
