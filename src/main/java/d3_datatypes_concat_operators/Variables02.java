...
public class Variables02 {
    public static void main(String[] args) {
        ...
        */
        ...
        //Ornek 2:Sehir ismi icin bir variable olusturun ve once "Ankara" sonra da "Izmir" degerlerini
        // atayip ekrana yazdirin.
        //Example 2: Create a variable for the city name and assign the values "Ankara" and
        // then "Izmir" and print it on the screen.
