...
public class InvalidStudentGradeException extends Exception{
    ...
    Bunun için genellikle Exception class’ini ya da daha spesifik bir child sınıfı genişleterek
     (extends) yeni bir class oluşturursunuz.

    Kendi exception class’larinizi oluşturmanız için birkaç neden vardır:

    1- Özelleştirilmiş İstisna Mesajları: Özel istisna sınıflarınızla, belirli bir hata durumu için daha anlamlı
    ve detaylı hata mesajları oluşturabilirsiniz.

    2-Daha İyi Hata Yönetimi: Özel istisnalar sayesinde hataları daha spesifik olarak yakalayıp,
    uygun şekilde yönetebilirsiniz.
